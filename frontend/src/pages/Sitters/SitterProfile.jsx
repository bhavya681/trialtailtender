...
const SitterProfile = () => {
    ...
    const fetchSitterById = async () => {
        try {
            const res = await fetch(`${import.meta.env.VITE_API_URL}/api/sitters/sitter/${sitterId}`, {
                method: 'GET',
                headers: {
                        ...
                        <div className="bg-white rounded-lg shadow overflow-hidden">
                            ...
                            <div className="pt-16 px-8 pb-8">
                                <div className="flex justify-between items-start">
                                    ...
                                    <Link to={`/message/${userSitterId}`} className="mt-8 px-2 py-2 h-[35px] text-[8px] bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors">
                                        <FaRocketchat size={20} />
                                    </Link>
                                </div>
                                <Link 
                                      to={`/booklist`}
                                      className="inline-flex mt-4 items-center px-6 py-3 bg-gradient-to-r from-blue-600 to-blue-800 text-white font-semibold rounded-lg shadow-md hover:from-blue-700 hover:to-blue-900 transform hover:scale-105 transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50"
                                    >
                        ...
                        <div className="bg-white rounded-lg shadow p-6">
                            ...
                            <div className="space-y-3">
                                <a href="#" className="flex items-center gap-2 text-gray-600 hover:text-gray-900">
                                    ...
                                    <span class="lowercase whitespace-nowrap">about.me/{user.name}</span>
                                </a>
                                <a href={`${sitter.facebook}`} className="flex items-center gap-2 text-gray-600 hover:text-gray-900">
                                    <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                                        <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z" />
                                    </svg>
                                    <span>Facebook</span>
                                </a>
                                <a href={`${sitter.instagram}`} className="flex items-center gap-2 text-gray-600 hover:text-gray-900">
                                    <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
